...
export default function Home() {
  ...
  // 🛡️ THE PERMANENT FIX: Safe checker bypass stops Vercel pre-render server crashes
        ...
        <div className="lg:col-span-1 bg-slate-900 rounded-2xl p-5 border border-slate-800 shadow-xl">
          ...
          <form onSubmit={handleAddProduct} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <input type="number" required value={quantity} onChange={e => setQuantity(e.target.value)} placeholder="Quantity" className="w-full p-3 bg-slate-950 border border-slate-800 rounded-xl text-slate-200 text-xs font-medium focus:outline-none focus:border-emerald-500" />
            </div>
